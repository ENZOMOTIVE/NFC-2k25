      ...
      <div className="w-full max-w-4xl relative overflow-hidden group mb-12">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr>
                <th className="py-3 md:py-4 px-4 md:px-6 bg-red-600 text-white rounded-tl-lg text-base md:text-lg font-semibold">Date</th>
                <th className="py-3 md:py-4 px-4 md:px-6 bg-red-600 text-white text-base md:text-lg font-semibold">Time</th>
                <th className="py-3 md:py-4 px-4 md:px-6 bg-red-600 text-white rounded-tr-lg text-base md:text-lg font-semibold">Teams</th>
              </tr>
            </thead>
            <tbody className="text-gray-100">
              {[
                { date: "Feb 13, 2025", time: "2:30 AM", teams: "SU vs NIST B" },
                { date: "Feb 13, 2025", time: "4:00 PM", teams: "NIST A vs Winner of Match 1" },
                
              ].map((fixture, index) => (
                <tr key={index} className={`border-b border-red-200 border-opacity-20 ${index % 2 === 0 ? "bg-red-900 bg-opacity-20" : "bg-red-800 bg-opacity-20"} hover:bg-red-700 hover:bg-opacity-30 transition-colors`}>
      ...
      <div className="w-full max-w-4xl relative overflow-hidden group">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr>
                <th className="py-3 md:py-4 px-4 md:px-6 bg-red-600 text-white rounded-tl-lg">Date</th>
                <th className="py-3 md:py-4 px-4 md:px-6 bg-red-600 text-white">Time</th>
                <th className="py-3 md:py-4 px-4 md:px-6 bg-red-600 text-white rounded-tr-lg">Teams</th>
              </tr>
            </thead>
            <tbody className="text-gray-100">
              {[
          ...
          <p className="text-center text-lg font-semibold mt-4">Fixtures for semifinals and will be declared soon</p>
